...
var G__29626 = shadow_root.activeElement;
active_element = G__29626;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__29607){
var map__29608 = p__29607;
var map__29608__$1 = cljs.core.__destructure_map(map__29608);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29608__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__29609 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__29610 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__29610);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__29609);
}}));
} else {
...
(jsprops.onChange = (function (p1__29617_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__29617_SHARP_);
}));
