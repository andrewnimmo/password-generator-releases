...
var G__29722 = o;
reagent.impl.template.goog$module$goog$object.set(G__29722,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__29759 = o;
reagent.impl.template.goog$module$goog$object.set(G__29759,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__29782 = props;
var G__29782__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29782,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__29782);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29782__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5162__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__29803 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29803,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__29803;
}
})(),id_class);
...
var temp__5825__auto___29838 = (function (){var and__5160__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___29838)){
var d_29839 = temp__5825__auto___29838;
if((d_29839 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_29839.s}));
} else {
...
var G__29804 = (cljs.core.count(argv) - first_child);
switch (G__29804) {
case (0):
...
var vec__29805 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29805,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29805,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29805,(2),null);
...
var temp__5829__auto___29842 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___29842 == null)){
} else {
var key_29843 = temp__5829__auto___29842;
(jsprops.key = key_29843);
}
...
var temp__5829__auto___29847 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___29847 == null)){
} else {
var key_29848 = temp__5829__auto___29847;
(jsprops.key = key_29848);
}
...
var temp__5829__auto___29849 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___29849 == null)){
} else {
var key_29850 = temp__5829__auto___29849;
...
var temp__5829__auto___29851 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___29851 == null)){
} else {
var key_29852 = temp__5829__auto___29851;
(jsprops.key = key_29852);
}
...
var temp__5829__auto___29875 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___29875 == null)){
} else {
var key_29877 = temp__5829__auto___29875;
(jsprops.key = key_29877);
}
...
var temp__5829__auto___29882 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___29882 == null)){
} else {
var key_29883 = temp__5829__auto___29882;
(jsprops.key = key_29883);
}
...
var ctx = ({});
var vec__29821 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29821,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29821,(1),null);
...
break;
default:
var G__29887 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__29888 = compiler;
v = G__29887;
compiler = G__29888;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template29827 = (function (opts,id,fn_to_element,parse_fn,meta29828){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template29827.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29829,meta29828__$1){
var self__ = this;
var _29829__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template29827(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta29828__$1));
}));

(reagent.impl.template.t_reagent$impl$template29827.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29829){
var self__ = this;
var _29829__$1 = this;
return self__.meta29828;
}));

(reagent.impl.template.t_reagent$impl$template29827.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template29827.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template29827.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template29827.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template29827.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template29827.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta29828","meta29828",-748763199,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template29827.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template29827.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template29827");

(reagent.impl.template.t_reagent$impl$template29827.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"reagent.impl.template/t_reagent$impl$template29827");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template29827.
 */
reagent.impl.template.__GT_t_reagent$impl$template29827 = (function reagent$impl$template$__GT_t_reagent$impl$template29827(opts,id,fn_to_element,parse_fn,meta29828){
return (new reagent.impl.template.t_reagent$impl$template29827(opts,id,fn_to_element,parse_fn,meta29828));
});
...
return (new reagent.impl.template.t_reagent$impl$template29827(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
